...
export const SignUpScreen: React.FC = () => {
    ...
    const navigateToSignInScreen = React.useCallback(() => navigate(ROUTES.signInScreen), [navigate]);
    ...
    return (
        <ScreenContainer>
            <TopContainer>
                ...
                <Button onPress={navigateToSignInScreen} mode="text" titleColor="#6979F8" title="Sign in" />
            </TopContainer>
            ...
            <Button title="Get started" titleColor="#FFFFFF" />
            <BottomContainer>
